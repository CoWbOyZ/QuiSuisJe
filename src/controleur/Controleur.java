	...
	public void jouer(){
		...
		while (!fini) {
			...
			case Controleur.LIRE_IDENTITE_J2 : // le joueur 1 est actif
				choix = this.lireIdentite(Controleur.MENU_JOUEUR1,"joueur1",joueur2.getIdentite());
				break;
			case Controleur.LIRE_IDENTITE_J1 : // le joueur 2 est actif 
				choix = this.lireIdentite(Controleur.MENU_JOUEUR2,"joueur2",joueur1.getIdentite());
				break;
